...
public class LessonDescriptorController {
    ...
    @PostMapping
    public ResponseEntity<LessonDescriptorResponse> createStudent(
        @RequestBody LessonDescriptorRequest lessonDescriptorRequest) {
        LessonDescriptor lessonDescriptor = LessonDescriptorConverter.toEntity(lessonDescriptorRequest);
        LessonDescriptor savedLessonDescriptor =
            lessonDescriptorService.createLessonDescriptor(lessonDescriptor, lessonDescriptorRequest.getMentorId());
        LessonDescriptorResponse dto = LessonDescriptorConverter.toDto(savedLessonDescriptor);
